...
const EXPERIENCES = [
  {
    title: "SimplifyTechnologies.",
    desc: "A Tech-Consulting Firm focused on delivering value at scale through best-practice business and simplified technologies.",
    duration: "May 2024 - Present",
    // img: oya,
    worksDone: [
      "Worked with the dev team to build software solutions for numerous financial institutions.",
      "Designed highly engaging, interactive user interfaces that comply with modern web standards.",
    ],
  },
  {
    title: "Sisenow.",
    ...
    // img: softwrk,
    worksDone: [
      "Collaborated with the dev team to design a user interface that meets client specifications.",
      "Translated client needs into technical site concepts to facilitate bidding and initial planning stages.",
      "Created captivating and interactive user interfaces that adhere to contemporary web standards.",
    ],
  },
  {
